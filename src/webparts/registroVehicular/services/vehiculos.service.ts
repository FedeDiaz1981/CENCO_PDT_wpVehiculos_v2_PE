...
export async function getVehiculoByPlaca(
  ...
  return {
    ...
    RielesLogisticos: it[VEH_FIELDS.RielesLogisticos],
    Propiedad: it[VEH_FIELDS.Propiedad],
...
export async function upsertVehiculo(v: Vehiculo, listTitle: string = LISTS.Vehiculos): Promise<number> {
  ...
  const payloadBase: any = {
    ...
    [VEH_FIELDS.RielesLogisticos]: asBool(v.RielesLogisticos),
    [VEH_FIELDS.Propiedad]: asBool(v.Propiedad),
